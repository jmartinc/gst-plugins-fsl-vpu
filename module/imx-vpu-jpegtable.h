...
#ifndef __VPU_JPEGTABLE_H__
#define __VPU_JPEGTABLE_H__
...
#define LOOKUP_TAB_MAX   8

/* MJPEG compress-ratio VS quality lookup Table */
unsigned char CompressRatioTable [LOOKUP_TAB_MAX] = { 56, 40, 18, 13,  8,  5,  3,  2};
unsigned char QualityLookupTable [LOOKUP_TAB_MAX] = {  5, 10, 30, 50, 75, 90, 95, 99};

#endif /* __VPU_JPEGTABLE_H__ */
